...
if __name__ == "__main__":
    selected_items = filter_avi_mp4_items(AVI_TO_MP4_MAP.items())
    print(f"馃幆 MM_INTENT_VIDEO_NAMES selected {len(selected_items)} video(s)")

    for avi_name, mp4_name in selected_items:
