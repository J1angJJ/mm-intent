...
TARGET_TIMESTEPS = int(os.getenv("MM_INTENT_TARGET_TIMESTEPS", "10"))
NUM_MODALITIES = 5
GESTURE_FEAT_DIM = int(os.getenv("MM_INTENT_GESTURE_FEAT_DIM", "768"))
IMU_FEAT_DIM = int(os.getenv("MM_INTENT_IMU_FEAT_DIM", "12"))
AUDIO_FEAT_DIM = int(os.getenv("MM_INTENT_AUDIO_FEAT_DIM", "39"))
TEXT_FEAT_DIM = int(os.getenv("MM_INTENT_TEXT_FEAT_DIM", "384"))
SCENE_FEAT_DIM = int(os.getenv("MM_INTENT_SCENE_FEAT_DIM", "768"))
